...
class InventoryEdit extends Component {
    ...
    //Async/await is used here to ensure data is
    //successfully fetched before adding the data to the state. 
    ...
    //handles live changes in the form elements and store each change in the state immediately
    handleChange = (event) => {
